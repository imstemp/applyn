    ...
    <DashboardLayout>
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* Sidebar - Quick Actions sticky at top */}
          <div className="lg:sticky lg:top-24 lg:self-start space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-soft border border-slate-200/50 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <Link
                  to="/coach"
                  className="group flex items-center w-full px-4 py-3 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white rounded-xl hover:from-violet-700 hover:to-fuchsia-700 shadow-md hover:shadow-lg transform hover:scale-[1.02] transition-all duration-200"
                >
